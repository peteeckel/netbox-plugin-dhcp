...
class PoolViewTestCase(
    ...
    def setUpTestData(cls):
        ...
        cls.csv_data = (
            "name,description,ip_range,client_class,required_client_classes,client_class_definitions,evaluate_additional_classes",  # noqa: E501
        ...
        cls.csv_update_data = (
            "id,description,ip_range,client_class,required_client_classes,client_class_definitions,evaluate_additional_classes",  # noqa: E501

...
class OptionViewTestCase(
    ...
    def setUpTestData(cls):
        ...
        cls.csv_data = (
            "description,space,name,code,data,dhcp_server,always_send,never_send,csv_format,assign_client_classes",  # noqa: E501
            f'Test Option 1,dhcp4,routers,,"192.0.2.1,192.0.2.2",{cls.dhcp_servers[0].name},false,false,true,"{cls.client_classes[0].name},{cls.client_classes[2].name}"',  # noqa: E501
            f'Test Option 2,dhcp4,,3,"192.0.2.3,192.0.2.4",{cls.dhcp_servers[1].name},false,true,false,"{cls.client_classes[1].name},{cls.client_classes[2].name}"',  # noqa: E501
            f'Test Option 3,dhcp4,domain-name-servers,,"192.0.2.5,192.0.2.6",{cls.dhcp_servers[2].name},false,false,false,"{cls.client_classes[0].name},{cls.client_classes[1].name}"',  # noqa: E501
        )

...
class SubnetViewTestCase(
    ...
    def setUpTestData(cls):
        ...
        cls.csv_data = (
            "name,description,prefix,client_classes,evaluate_additional_classes",  # noqa: E501
            f'test-shared-network-4,Test Subnet 4,{ipv4_prefixes[0].prefix},"{client_classes[0].name},{client_classes[1].name}","{client_classes[1].name},{client_classes[2].name}"',  # noqa: E501
            f'test-shared-network-5,Test Subnet 5,{ipv4_prefixes[1].prefix},"{client_classes[1].name},{client_classes[2].name}","{client_classes[2].name},{client_classes[0].name}"',  # noqa: E501
            f'test-shared-network-6,Test Subnet 6,{ipv4_prefixes[2].prefix},"{client_classes[2].name},{client_classes[0].name}","{client_classes[0].name},{client_classes[1].name}"',  # noqa: E501
        )

# Welcome to NetBox DHCP Contribution Guidelines
...
$ git remote add upstream https://github.com/peteeckel/netbox-plugin-dhcp.git
```
...
```bash
$ pip3 -e /install-path/netbox-plugin-dhcp
...
To achieve a consistent coding style, all code for the NetBox DHCP plugin is formatted using the `black` utility. For more details, see the [documentation](https://black.readthedocs.io/en/stable/index.html) for `black`.
